...
void check_net_send(){
    uint32_t head_idx;
    uint32_t tail_idx;
    if(net_send_queue.index != -1){
        head_idx = e1000_read_reg(e1000, E1000_TDH);
        tail_idx = e1000_read_reg(e1000, E1000_TDT);
        if(tail_idx - 1 != head_idx){
...
void check_net_recv(){
    uint32_t head_idx;
    uint32_t tail_idx;
    if(net_recv_queue.index != -1){
        head_idx = e1000_read_reg(e1000, E1000_RDH);
